...
enum class Errors(val message: String, val responseMessage: String, val errorCode: HttpStatus) {
    ...
    USER_NOT_FOUND("User not found", "Usuário não encontrado.", HttpStatus.NOT_FOUND), CANT_RETRIEVE_USERS(
    ...
    LAST_WORK_HISTORY_NOT_FOUND(
        "Last work history not found", "Último histórico de trabalho não encontrado.", HttpStatus.NOT_FOUND
    ),
    ...
    CSV_TEMPLATE_NOT_FOUND(
        "CSV template not found",
        "Modelo CSV não encontrado.",
        HttpStatus.NOT_FOUND
    ),
    CSV_FIELD_NOT_FOUND(
        "CSV field not found",
        "Campo CSV não encontrado.",
        HttpStatus.NOT_FOUND
    ),
    CANT_CREATE_COURSE(
